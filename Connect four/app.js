document.addEventListener('DOMContentLoaded', () => {
    ...
    (function(index){
        ...
        squares[i].onclick = function() {
            // if the square below the current square is taken, you can go on top of it
            if (squares[index + 7].classList.contains('taken')) {
                ...
                // if the square below the current square is not taken, you can't go here
    ...
    function checkBoard() {
        ...
        for(let y = 0; y < winningArrays.length; y++) {
            ...
            // check arrays to see if all have the class of player-one
            ...
            // check to see if they all have the class of player-two
